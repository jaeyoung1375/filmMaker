...
<div class="container">
	...
	<form id="join_form" method="post">
		...
		<!-- 이름 입력 칸 -->
		<div class="join_id">
			<label class="id_title">이름</label>
			<div class="id_comment">한글 또는 영문으로 입력해주세요.</div>
			<label>
				<input type="text" class="id_input" name="memberName" placeholder="이름" id="id">
			</label>
		...
		<div class="join_tel">
			<label class="tel_title">전화번호</label>
			<div class="tel_comment">전화번호 입력 코멘트칸.</div>
			<label>
				<input type="tel" class="id_input" name="memberTel" placeholder="전화번호" id="id">
			</label>
		</div>
		
		
	         <div class ="bir_wrap">
	           	<label class="birth_title">생년월일</label>
	                     <!--  <select v-model="selectedYear" id="year" class="form-select" @blur="saveMemberBirth">
	                       ...
	                       <select id="year" class="form-select">
	                        ...
	                        <select class="form-select" id="month" id="exampleSelect1">
	                            <option value="1">1월</option>
	                         </select>
	                    <select class="form-select" id="day" id="exampleSelect1">
